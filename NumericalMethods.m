...
set(handles.chapter3plusuipanel,'visible','off')
...
function re_bb_Callback(hObject, eventdata, handles)
% hObject    handle to re_bb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of re_bb as text
%        str2double(get(hObject,'String')) returns contents of re_bb as a double


% --- Executes during object creation, after setting all properties.
function re_bb_CreateFcn(hObject, eventdata, handles)
% hObject    handle to re_bb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
switch get(get(handles.uipanel33,'SelectedObject'),'String')
            ...
            case '2'
                [edit98,edit99,edit100] = ch2_curve_fitting_2(edit223, edit220, edit221, edit224, edit222)
                set(handles.edit98, 'string', edit98);
                set(handles.edit99, 'string', edit99);
                set(handles.edit100, 'string', edit100);
            case '3'
                [edit98,edit99,edit100] = ch2_curve_fitting_3(edit223, edit220, edit221, edit224, edit222)
                set(handles.edit98, 'string', edit98);
                set(handles.edit99, 'string', edit99);
                set(handles.edit100, 'string', edit100);
            case '4'
                [edit98,edit99,edit100] = ch2_curve_fitting_4(edit223, edit220, edit221, edit224, edit222)
                set(handles.edit98, 'string', edit98);
                set(handles.edit99, 'string', edit99);
                set(handles.edit100, 'string', edit100);
            case '5'
                % BAYAD ESLAAH SHAVAD
                [edit98,edit99,edit100] = ch2_curve_fitting_5(edit223, edit220, edit221, edit224, edit222)
                set(handles.edit98, 'string', edit98);
                set(handles.edit99, 'string', edit99);
                set(handles.edit100, 'string', edit100);
            case 'All'
...
switch get(get(handles.uipanel39,'SelectedObject'),'String')
            case 'Cholesky'
                res=Cholesky(edit152,edit149);
            case 'Cramer'
                res=cramer(edit159,edit158);
            case 'Doolittle'
                res=doolittle(edit152,edit149);
            case 'Eigen'
                res=eigen(edit161);
                res=char(res);
            case 'Gauss Elimination'
                res=gaussElimination(edit152,edit149);
            case 'Power Method'
                res=PowerMethod(edit154,edit153,edit155);
            case 'Jacobi'
                res = jacobi(edit184,edit183,edit185,edit186);
            case 'Gauss Seidel'
                res = gaussSeidel(edit184 ,edit183,edit185 , edit186)
            otherwise, res = '';
end
set(handles.text183, 'string', res);
...
switch get(get(handles.uipanel38,'SelectedObject'),'String')
            case 'Trapezodial'
                set(handles.uipanel49,'visible','on')
            ...
            case 'Gaussleg'
                ...
                set(handles.uipanel53,'visible','off')
            case 'Diff Main'
                set(handles.uipanel49,'visible','off')
...
% --- Executes when selected object is changed in uipanel40.
function uipanel40_SelectionChangeFcn(hObject, eventdata, handles)
% hObject    handle to the selected object in uipanel40 
% eventdata  structure with the following fields (see UIBUTTONGROUP)
%	EventName: string 'SelectionChanged' (read only)
%	OldValue: handle of the previously selected object or empty if none was selected
%	NewValue: handle of the currently selected object
...
% --- Executes when selected object is changed in uipanel39.
function uipanel39_SelectionChangeFcn(hObject, eventdata, handles)
% hObject    handle to the selected object in uipanel39 
% eventdata  structure with the following fields (see UIBUTTONGROUP)
%	EventName: string 'SelectionChanged' (read only)
%	OldValue: handle of the previously selected object or empty if none was selected
%	NewValue: handle of the currently selected object
...
switch get(get(handles.uipanel39,'SelectedObject'),'String')
            case 'Cholesky'
                set(handles.uipanel54,'visible','on')
                set(handles.uipanel58,'visible','off')
                set(handles.uipanel57,'visible','off')
                set(handles.uipanel55,'visible','off')
                set(handles.uipanel69,'visible','off')
            case 'Cramer'
                set(handles.uipanel54,'visible','off')
                set(handles.uipanel58,'visible','off')
                set(handles.uipanel57,'visible','on')
                set(handles.uipanel55,'visible','off')
                set(handles.uipanel69,'visible','off')
            case 'Doolittle'
                set(handles.uipanel54,'visible','on')
            ...
            case 'Eigen'
                set(handles.uipanel54,'visible','off')
                set(handles.uipanel58,'visible','on')
                set(handles.uipanel57,'visible','off')
                set(handles.uipanel55,'visible','off')
                set(handles.uipanel69,'visible','off')
            case 'Gauss Elimination'
            ...
            case 'Jacobi'
                ...
                set(handles.uipanel57,'visible','off')
                set(handles.uipanel55,'visible','off')
                set(handles.uipanel69,'visible','on')
            case 'Gauss Seidel'
                set(handles.uipanel54,'visible','off')
                set(handles.uipanel58,'visible','off')
                set(handles.uipanel57,'visible','off')
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    % Method
    if (get(handles.radiobutton19,'Value') == 0 && get(handles.radiobutton20,'Value') == 0 )
    else
        %do this if a user selected a radio button
          switch get(get(handles.uipanel26,'SelectedObject'),'Tag')
              case 'radiobutton19',  RM= 'chopping';
              case 'radiobutton20',  RM = 'symmetric';
          end
    end
    
    % Get Errors
    e_a=str2num(get(handles.edit50, 'string'));
    if isempty(e_a) 
        e_a='';
    end
    e_b=str2num(get(handles.edit47, 'string'));
    if isempty(e_b) 
        e_b='';
    end
    e_c=str2num(get(handles.edit48, 'string'));
    if isempty(e_c) 
        e_c='';
    end
    e_d=str2num(get(handles.edit49, 'string'));
    if isempty(e_d) 
        e_d='';
    end
    e_e=str2num(get(handles.edit51, 'string'));
    if isempty(e_e) 
        e_e='';
    end
    e_f=str2num(get(handles.edit52, 'string'));
    if isempty(e_f) 
        e_f='';
    end
    
    % Get Values
    a=str2num(get(handles.edit74, 'string'));
    if isempty(a) 
        a='';
    end
    b=str2num(get(handles.edit71, 'string'));
    if isempty(b) 
        b='';
    end
    c=str2num(get(handles.edit72, 'string'));
    if isempty(c) 
        c='';
    end
    d=str2num(get(handles.edit73, 'string'));
    if isempty(d) 
        d='';
    end
    e=str2num(get(handles.edit75, 'string'));
    if isempty(e) 
        e='';
    end
    ff=str2num(get(handles.edit76, 'string'));
    if isempty(ff) 
        ff='';
    end
...
% --- Otherwise, executes on mouse press in 5 pixel border or over runbutton.
function runbutton_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to runbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in chapter3plusbutton.
function chapter3plusbutton_Callback(hObject, eventdata, handles)
% hObject    handle to chapter3plusbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.welcomeuipanel,'visible','off')
set(handles.chapter1uipanel,'visible','off')
...
set(handles.chapter3plusuipanel,'visible','on')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
edit206=str2num(get(handles.edit206, 'string'));
edit203=str2num(get(handles.edit203, 'string'));
edit204=str2num(get(handles.edit204, 'string'));
edit205=str2num(get(handles.edit205, 'string'));
edit207=str2num(get(handles.edit207, 'string'));

switch get(get(handles.uipanel85,'SelectedObject'),'String')
            case 'a*sin(x)+b'
                
                [edit282,edit284,edit286] = ch2_curve_fitting_61(edit206, edit203, edit204, edit207, edit205)
            case 'a*cos(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_62(edit206, edit203, edit204, edit207, edit205)
            case 'a*x*sin(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_71(edit206, edit203, edit204, edit207, edit205)
            case 'a*x*cos(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_72(edit206, edit203, edit204, edit207, edit205)
            case 'a*tan(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_81(edit206, edit203, edit204, edit207, edit205)
            case 'a*cot(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_82(edit206, edit203, edit204, edit207, edit205)
            case 'a*sec(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_91(edit206, edit203, edit204, edit207, edit205)
            case 'a*csc(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_92(edit206, edit203, edit204, edit207, edit205)
            case 'a*arcsin(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_93(edit206, edit203, edit204, edit207, edit205)
            case 'a*arccos(x)+b'
                [edit282,edit284,edit286] = ch2_curve_fitting_94(edit206, edit203, edit204, edit207, edit205)
            otherwise, res = '';
end
                set(handles.text282, 'string', edit282);
                set(handles.text284, 'string', edit284);
                set(handles.text286, 'string', edit286);
